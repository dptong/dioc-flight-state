...
```
cd existing_repo
git remote add origin http://192.168.136.118/comac/FLYWIN-BackEnd.git
git branch -M main
...
- [ ] [Set up project integrations](http://192.168.136.118/comac/FLYWIN-BackEnd/-/settings/integrations)
